...
def classifier(img_path):
    ...
    model_path=os.path.join(model_path,'bargraph_classifier_50epoch_vgg16.h5')
    # mymodel = tf.keras.models.load_model("/home/arpit/Desktop/scientific_chart_reader/webapp/webapp/core/maincode/bargraph_classifier_50epoch_vgg16.h5")
