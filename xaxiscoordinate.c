...
{
    "distutils": {
        "name": "xaxiscoordinate",
        "sources": [
            "xaxiscoordinate.pyx"
        ]
    },
    "module_name": "xaxiscoordinate"
}
END: Cython Metadata */
...
#define __PYX_HAVE__xaxiscoordinate
#define __PYX_HAVE_API__xaxiscoordinate
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'xaxiscoordinate' */
...
#define __Pyx_MODULE_NAME "xaxiscoordinate"
extern int __pyx_module_is_main_xaxiscoordinate;
int __pyx_module_is_main_xaxiscoordinate = 0;

/* Implementation of 'xaxiscoordinate' */
...
static PyObject *__pyx_f_15xaxiscoordinate_xaxiscoordinate(__Pyx_memviewslice __pyx_v_image) {
  int __pyx_v_h;
  int __pyx_v_w;
  int __pyx_v_flag;
  int __pyx_v_y;
  ...
  __Pyx_RefNannySetupContext("xaxiscoordinate", 0);

  /* "xaxiscoordinate.pyx":6
 * cdef list xaxiscoordinate(unsigned char [:,:] image):
 *     cdef int h,w,flag,y,x,i
 *     h=image.shape[0]             # <<<<<<<<<<<<<<
 *     w=image.shape[1]
 ...
 *             flag=1
 */
  for (__pyx_t_1 = (__pyx_v_h - 1); __pyx_t_1 > 0; __pyx_t_1-=1) {
    __pyx_v_y = __pyx_t_1;

    /* "xaxiscoordinate.pyx":10
 *     flag=0
 *     for y in range(h-1,0,-1):
 *         for x in range(0,w*2//3,5):             # <<<<<<<<<<<<<<
 *             flag=1
 *             for i in range(0,5):
 */
    __pyx_t_2 = __Pyx_div_long((__pyx_v_w * 2), 3);
    __pyx_t_3 = __pyx_t_2;
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=5) {
      __pyx_v_x = __pyx_t_4;

      /* "xaxiscoordinate.pyx":11
 *     for y in range(h-1,0,-1):
 *         for x in range(0,w*2//3,5):
 *             flag=1             # <<<<<<<<<<<<<<
 *             for i in range(0,5):
 ...
 */
        __pyx_t_6 = __pyx_v_y;
        __pyx_t_7 = (__pyx_v_x + __pyx_v_i);
        if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_image.shape[0];
        if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_image.shape[1];
        __pyx_t_8 = (((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_6 * __pyx_v_image.strides[0]) ) + __pyx_t_7 * __pyx_v_image.strides[1]) ))) != 0) != 0);
        if (__pyx_t_8) {

          /* "xaxiscoordinate.pyx":14
 *             for i in range(0,5):
 *                 if image[y,x+i]!=0:
 *                     flag=0             # <<<<<<<<<<<<<<
 *                     break
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "xaxiscoordinate.pyx":17
 *                     break
 *             if flag==1:
 *                 return [y,x]             # <<<<<<<<<<<<<<
 */
        __Pyx_XDECREF(__pyx_r);
        __pyx_t_9 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __pyx_t_10 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 17, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("xaxiscoordinate.xaxiscoordinate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "xaxiscoordinate.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "xaxiscoordinate._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_xaxiscoordinate(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_xaxiscoordinate},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initxaxiscoordinate(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initxaxiscoordinate(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_xaxiscoordinate(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_xaxiscoordinate(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_xaxiscoordinate(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'xaxiscoordinate' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_xaxiscoordinate(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("xaxiscoordinate", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_xaxiscoordinate) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "xaxiscoordinate")) {
      if (unlikely(PyDict_SetItemString(modules, "xaxiscoordinate", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init xaxiscoordinate", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init xaxiscoordinate");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
